...
Bei der in Abbildung \ref{fig:hallspannung_aufbau} skizzierten Flussrichtung ist eine Ablenkung nach der Rechte-Hand-Regel gegeben. Ändert man die Flussrichtung entgegengesetzt ändert sich das Vorzeichen und positive Ladungen entsprechen nun dem Fluss in die ursprüngliche Richtung. Die umgekrehte Stromrichtung führt zu einer entgegengesetzten Ablenkung der negativen Ladungen. Da nun positive Ladungen vorhanden sind, ist die Hallspannung unabhängig von der Stromrichtung. Zu sehen ist dieser Zusammenhang in der Gleichung:
$$U_H = - \frac{1}{nq} \cdot \frac{I \cdot B}{d}$$

\subsection{Versuchsaufbau}
Die Versuche werden mit verdrahteten Proben auf einer Paltine mit Elektromagneten und Netzteilen durchgeführt. In Abbildung \ref{fig:probe_aufbau} ist eine eingespannte Probe schematisch dargestellt [1 p.10 Abb. 6].
...
\end{figure}
 ...
 Mit einer Eichmessung ergibt sich ein Fluss pro Ampere welcher in [1 p.11] mit 
